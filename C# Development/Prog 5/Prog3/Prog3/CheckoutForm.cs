...
namespace LibraryItems
{
    public partial class CheckoutForm : Form
    {
        ...
        internal string CallNum
        {
            ...
            {
                // Precondition:  None
                // Postcondition: The call num of the selected index is returned
                return _items[itemCbo.SelectedIndex].CallNumber;
            }
        }
        ...
        {
            // Precondition:  None
            // Postcondition: The patron ID of the selected index is returned
            get
            {
                return _patrons[patronCbo.SelectedIndex].PatronID;
            }
        }
